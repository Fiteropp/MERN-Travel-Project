...
import UserTabUserInfo from "./UserProfileTabs/UserTabUserInfo";
import UserTabBookingHistory from "./UserProfileTabs/UserTabBookingHistory";
    ...
    <Box sx={{ width: '100%' }}>
      <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
        <Tabs value={value} onChange={handleChange} centered variant="fullWidth" aria-label="basic tabs example" className="tabs-sp-bw">
          ...
          <Tab className="tab-style" label="Bookings" {...a11yProps(1)} />
